...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  final _lodgeController = TextEditingController();
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          fillColor: royalLight.withValues(alpha: 0.05), // subtle royal tint
          contentPadding:
  ...
  Future<void> _sendOtp() async {
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          'lodgeId': int.parse(_lodgeController.text.trim()),
          'userId': _userController.text.trim(),
          'otp': (100000 + (DateTime.now().millisecondsSinceEpoch % 899999)).toString(),
        }),
      );
            ...
            child: Padding(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    _buildTextField(
                      controller: _lodgeController,
                      icon: Icons.home_work_rounded,
                      label: "Lodge ID",
                      keyboard: TextInputType.number,
                      validator: (v) =>
                      v == null || v.isEmpty ? "Enter Lodge ID" : null,
                    ),
