...
class UpcomingDetailsPage extends StatefulWidget {
  ...
  @override
  State<UpcomingDetailsPage> createState() => _BookingDetailsPageState();
}

class _BookingDetailsPageState extends State<UpcomingDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Upcoming Events Details"),
        centerTitle: true,
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              onPressed: () {
                ...
                // 🧩 Convert the raw booking data to a clean formatted map
                final formattedBooking = {
                  'hall_id': booking['hall_id'],
                  'user_id': booking['user_id'],
                  'function_date': DateFormat('yyyy-MM-dd').format(
                    DateTime.parse(booking['function_date']),
                  ),
                ...
                // 🏛️ Format hall details (keep it consistent)
                final formattedHall = {
                  ...
                  'instructions': hallDetails?['instructions'] ?? [],
                };

                // 🧾 Print formatted data before sending
                print("📦 Booking Data: $formattedBooking");
                print("🏛️ Hall Details: $formattedHall");
