    ...
    setState(() {
      ...
      _filteredBookings = _bookings.where((b) {
        ...
        return functionDate.year == _selectedMonth.year &&
            ...
            functionDate.isBefore(DateTime(
                yesterday.year, yesterday.month, yesterday.day + 1)); // ✅ only until yesterday
      }).toList();
    });
  }
    ...
    await showDialog(
      ...
      builder: (context) {
        return Dialog(
          ...
          backgroundColor: Color(0xFFECE5D8).withValues(alpha:0.95),
          child: Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            if (_filteredBookings.isEmpty)
              ...
              ..._filteredBookings.map((b) => _bookingCard(b)),
