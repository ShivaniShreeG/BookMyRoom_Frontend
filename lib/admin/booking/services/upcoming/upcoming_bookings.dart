...
import 'upcoming_booking_details.dart';
...
class UpcomingBookingsPage extends StatefulWidget {
  ...
  @override
  State<UpcomingBookingsPage> createState() => _UpcomingBookingPageState();
}

class _UpcomingBookingPageState extends State<UpcomingBookingsPage> {
