...
import 'partial_cancel.dart';

const Color royalblue = Color(0xFF376EA1);
const Color royal = Color(0xFF19527A);
const Color royalLight = Color(0xFF629AC1);

class CancelBookedPage extends StatefulWidget {
  const CancelBookedPage({super.key});

  @override
  State<CancelBookedPage> createState() => _CancelBookedPageState();
}

class _CancelBookedPageState extends State<CancelBookedPage> {
  ...
  Future<void> _loadBookings() async {
    ...
    try {
      final url = Uri.parse("$baseUrl/cancels/prebooked/$lodgeId");
        ...
        showDialog(
          ...
          builder: (context) {
            return AlertDialog(
              ...
              content: Text(
                "Do you want to cancel fully or partially?",
